...
module.exports.disablePerfMonitor = function () {
    ...
    Metrics.removeMetricByName(PERF.WAF.FULL);
    Metrics.removeMetricByName(PERF.WAF.CACHE_HIT_RATE);
    Metrics.removeMetricsByPrefix(PERF.WAF.RULE_PREFIX);
};

// CHECKME: Am I used anywhere?
