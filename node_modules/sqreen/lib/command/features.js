...
const getDefaultMetric = module.exports.getDefaultMetric = function () {
...
const commands = {
    ...
    synchronous_blocking: function (value) {}, // state holding
    log_rules_execution: function (value) {}, // state holding
