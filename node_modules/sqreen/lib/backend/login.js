...
const buildPayload = module.exports._buildPayload = function (deps_signature, pid, process_limits) {
    ...
    let libsqreen_install_artifacts = null;
    let libsqreen_runtime_artifacts = null;
    const libsqreen_enabled = config.libsqreen;
    if (config.libsqreen) {
        try {
            const Lib = require('sq-native');
            libsqreen_version = Lib.getVersion();
            libsqreen_install_artifacts = Lib.getInstallArtefacts();
            libsqreen_runtime_artifacts = Lib.getCurrentSetup();
        }
        catch (_) {}
    }
    ...
    return {
        ...
        various_infos: {
            ...
            libsqreen_version,
            libsqreen_install_artifacts,
            libsqreen_runtime_artifacts,
            libsqreen_enabled
        },
        agent_type: 'nodejs',
