...
exports.FailedToInitLocalCacheError = exports.cleanLocalCache = exports.initLocalCache = exports.getLocalCachePath = exports.REQUIRED_LOCAL_CACHE_FILES = exports.LOCAL_POLICY_ENGINE_DIR = void 0;
...
class FailedToInitLocalCacheError extends custom_error_1.CustomError {
    constructor(message) {
...
class FailedToCleanLocalCacheError extends custom_error_1.CustomError {
    constructor(message) {
