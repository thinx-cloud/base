...
const wrappers = module.exports.wrappers = new Map();

/**
 * WARNING: using this is dangerous and can break modules (for instance express)
 * @param packageName
 * @param wrapper
 */
instrumentationInterface.setWrapCallback = function (packageName, wrapper) {

    wrappers.set(packageName, wrapper);
};
