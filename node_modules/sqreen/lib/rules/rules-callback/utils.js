...
const writeHead = module.exports.writeHead = function (res, status, headers) {
...
module.exports.pick = function (item, fields) {

    const result = {};

    if (item === null || typeof item !== 'object' || Array.isArray(item) === true) {
